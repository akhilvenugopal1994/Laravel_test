         ...
         <div class="container-fluid">
            <div class="row">
               <div class="col-lg-12 p-0">
                  <img src="<?php echo e(asset('assets/dist/img/bnr.png')); ?>" alt="">
               </div>
            </div>
         </div>
         <div class="container">
...
<script>
    $(document).ready(function(){
          ...
          var timestamp = '<?php echo e(Session::get('visitor')); ?>';
          if(!timestamp){
              $.ajax({
                  url: "<?php echo e(route('saveVisitor')); ?>",
                  type:'POST',
                  data: {
...
//           e.preventDefault(); 
           ...
           $.ajax({
                  ...
                  success: function (response){
                      ...
                      var url = '<?php echo e(route("showSucess", ":slug")); ?>';
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Test\laravel_test\resources\views/welcome.blade.php ENDPATH**/ ?>